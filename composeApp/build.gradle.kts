...
android {
    namespace = "org.advdropthebeatproject.reborn"
    compileSdk = libs.versions.android.compileSdk.get().toInt()

    defaultConfig {
        applicationId = "org.advdropthebeatproject.reborn"
...
compose.desktop {
    application {
        mainClass = "org.advdropthebeatproject.reborn.MainKt"

        nativeDistributions {
            targetFormats(TargetFormat.Dmg, TargetFormat.Msi, TargetFormat.Deb)
            packageName = "org.advdropthebeatproject.reborn"
